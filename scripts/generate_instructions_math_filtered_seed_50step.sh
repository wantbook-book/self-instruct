...
TOKENIZERS_PARALLELISM=false python self_instruct/bootstrap_instructions.py \
    ...
    --engine "/pubshare/fwk/orlhf_checkpoints/checkpoint/llama3-3b-filtered_correct_0_2_0_8_gen_math_7_5k_random_bon_maj_bs16_2/global_step50_hf" \
    --request_batch_size 5 \
    --num_prompt_instructions 8 \
    --prompt /pubshare/fwk/code/self-instruct/self_instruct/prompts/question_generation.json \
    --tag "train_filtered_correct_0_2_0_8_seed_gen_7500_step50" \
